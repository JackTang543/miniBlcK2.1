...
#define DC_GPIO_PIN    GPIO_PIN_2
#define DC_GPIO_CLK_EN __GPIOB_CLK_ENABLE
...
int8_t sDRV_GenOLED_Init(){
    //选择初始化SPI还是I2C
        ...
        if(sBSP_SPI1M_Init(SPI_BAUDRATEPRESCALER_4) != 0){
            return -1;
        }
        //设置默认电平
        setCS(1);
